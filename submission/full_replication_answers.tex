...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.07}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.07}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.07}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.07}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 26\tabcolsep) * \real{0.07}}
...
\tightlist
\item
  ADF test on \texttt{ΔY}: statistic = -71.831, p-value = 0.0000
\item
  ADF test on \texttt{ΔX}: statistic = -26.107, p-value = 0.0000
\end{itemize}
...
\tightlist
\item
  First stage for \texttt{ΔY\_(t-1)}: R² = 0.5117
\item
  First stage for \texttt{ΔX\_(t-1)}: R² = 0.7811
\end{itemize}

The first-stage R² values are not especially low in this simplified
